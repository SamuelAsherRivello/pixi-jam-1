export class KeyCode {
    ...
    public static readonly UpArrow: number = 38;
    public static readonly RightArrow: number = 39;
    public static readonly DownArrow: number = 40;
    ...
    // Control keys
    public static readonly LeftControl: number = 17;
    public static readonly RightControl: number = 17;
    public static readonly LeftShift: number = 16;
    public static readonly RightShift: number = 16;
    public static readonly LeftAlt: number = 18;
    public static readonly RightAlt: number = 18;
    public static readonly LeftMeta: number = 91; // Windows key / Command key on Mac
    public static readonly RightMeta: number = 93; // Windows key / Command key on Mac
}
